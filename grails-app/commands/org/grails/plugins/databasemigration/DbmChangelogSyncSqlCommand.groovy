...
@CompileStatic
class DbmChangelogSyncSqlCommand implements ApplicationCommand, DatabaseMigrationCommand {

    final String description = 'Writes SQL to mark the next change in the database to STDOUT or a file'
