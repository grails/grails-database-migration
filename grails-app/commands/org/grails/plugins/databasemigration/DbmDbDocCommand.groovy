...
@CompileStatic
class DbmDbDocCommand implements ApplicationCommand, DatabaseMigrationCommand {
    ...
    boolean handle(ExecutionContext executionContext) {
        ...
        def destination = commandLine.remainingArgs[0] ?: "${executionContext.targetDir.path}/dbdoc" as String
