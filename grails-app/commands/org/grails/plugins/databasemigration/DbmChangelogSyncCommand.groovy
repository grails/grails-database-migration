...
@CompileStatic
class DbmChangelogSyncCommand implements ApplicationCommand, DatabaseMigrationCommand {

    final String description = 'Marks all changes as executed in the database'
