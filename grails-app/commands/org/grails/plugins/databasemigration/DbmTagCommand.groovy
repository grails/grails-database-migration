...
@Commons
@CompileStatic
class DbmTagCommand implements ApplicationCommand, DatabaseMigrationCommand {

    final String name = 'Adds a tag to mark the current database state'
    ...
    boolean handle(ExecutionContext executionContext) {
        ...
        if (!tagName) {
            log.error "The $name command requires a tag"
            return false
        }
