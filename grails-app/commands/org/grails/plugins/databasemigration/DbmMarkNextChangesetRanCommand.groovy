...
@CompileStatic
class DbmMarkNextChangesetRanCommand implements ApplicationCommand, DatabaseMigrationCommand {

    final String description = 'Mark the next change changes as executed in the database'
