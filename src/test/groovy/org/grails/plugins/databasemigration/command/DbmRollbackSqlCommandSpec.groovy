...
class DbmRollbackSqlCommandSpec extends ScriptDatabaseMigrationCommandSpec {

    final Class<ScriptDatabaseMigrationCommand> commandClass = DbmRollbackSqlCommand
    ...
    def setup() {
        ...
        new DbmUpdateCountCommand().handle(getExecutionContext('1'))
        new DbmTagCommand().handle(getExecutionContext('test-tag'))
