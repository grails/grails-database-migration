def Product = grailsApplication.getDomainClass('migrationtests.Product').clazz
def Order = grailsApplication.getDomainClass('migrationtests.Order').clazz
def Report = grailsApplication.getDomainClass('migrationtests.Report').clazz
